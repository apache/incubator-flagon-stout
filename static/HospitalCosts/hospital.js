...
// var ac = new activityLogger().testing(true).echo(true).mute(['SYS']);
var ac = {};
...
var home = {vis: null,
		  ...
		  if(this.value == "None")
			{
				ac.logUserActivity("User removed data highlighting.", "highlightData", ac.WF_EXAMINE);
			}else{
                  		ac.logUserActivity("User highlighted a subset of data.", "highlightData", ac.WF_EXAMINE);
			}
                });
                ...
                d3.select("#scope").on("change", function () {
                    ...
                    if (state === "Entire U.S.") {
                      ...
                      home.update();
                        ...
                        ac.logUserActivity("User zoomed to data subset.", "changeDataScope", ac.WF_EXAMINE);
                        home.scope = "state";
                ...
                d3.select("#order-cost").on("click", function () { home.order = "cost"; home.update(); ac.logUserActivity("Reorder Bar Chart by Cost", "changeXAxis",  ac.WF_EXAMINE);});
                d3.select("#order-reimbursement").on("click", function () { home.order = "reimbursement"; home.update(); ac.logUserActivity("Reorder Bar Chart by Reimbursement", "changeXAxis",  ac.WF_EXAMINE);});
                d3.select("#order-mortality").on("click", function () { home.order = "mortality"; home.update(); ac.logUserActivity("Reorder Bar Chart by Mortality", "changeXAxis",  ac.WF_EXAMINE);});

                d3.select("#scale-cost").on("click", function () { home.scale = "cost"; home.update(); ac.logUserActivity("Set Bar Chart Scale to Cost", "changeYAxis",  ac.WF_EXAMINE);});
                d3.select("#scale-reimbursement").on("click", function () { home.scale = "reimbursement"; home.update(); ac.logUserActivity("Set Bar Chart Scale to Reimbursement", "changeYAxis",  ac.WF_EXAMINE);});
                d3.select("#scale-mortality").on("click", function () { home.scale = "mortality"; home.update(); ac.logUserActivity("Set Bar Chart Scale to Mortality", "changeYAxis",  ac.WF_EXAMINE);});

                d3.select("#treatment-heart").on("click", function () { home.treatment = "heart failure"; home.update(); ac.logUserActivity("Data source changed to heart failure.", "changeDataSource",  ac.WF_SEARCH); });
                d3.select("#treatment-pneumonia").on("click", function () { home.treatment = "pneumonia"; home.update(); ac.logUserActivity("Data source changed to pneumonia.", "changeDataSource",  ac.WF_SEARCH) });
			...
			else
			{
				actionString = "removed from";
                        ...
                        home.update();
			ac.logUserActivity("Moving Average " + actionString + " Chart", "summerizeData",  ac.WF_MARSHAL);
                    });
			...
			else
			{
				actionString = "removed from";
                        ...
                        home.update();
			ac.logUserActivity("National Average " + actionString + " Chart", "summerizeData",  ac.WF_MARSHAL);
                    });
            },
...
/*                else {*/
        ...
        d3.select("#scatter-treatment-pneumonia")
            .on("click", function () {
                ...
                scatter.update();
		ac.logUserActivity("Change scatterplot dataset to pneumonia", "changeDataSource",  ac.WF_SEARCH);
            });
        d3.select("#scatter-treatment-heart")
            .on("click", function () {
		ac.logUserActivity("Change scatterplot dataset to heart failure", "changeDataSource",  ac.WF_SEARCH);
        ...
        d3.select("#scatter-x-cost")
            .on("click", function () {
                scatter.xvar = "cost";
		ac.logUserActivity("Change scatterplot X-axis to treatment cost", "changeXAxis",  ac.WF_EXAMINE);
                scatter.update();
            });
        d3.select("#scatter-x-reimbursement")
            .on("click", function () {
                ...
                scatter.update();
		ac.logUserActivity("Change scatterplot X-axis to Medicare reimbursement", "changeXAxis",  ac.WF_EXAMINE);
            });
        d3.select("#scatter-x-mortality")
            .on("click", function () {
                scatter.xvar = "mortality";
		ac.logUserActivity("Change scatterplot X-axis to mortality rate", "changeXAxis",  ac.WF_EXAMINE);
                scatter.update();
            });
        ...
        d3.select("#scatter-y-cost")
            .on("click", function () {
                scatter.yvar = "cost";
		ac.logUserActivity("Change scatterplot Y-axis to treatment cost", "changeYAxis",  ac.WF_EXAMINE);
                scatter.update();
            });
        d3.select("#scatter-y-reimbursement")
            .on("click", function () {
                scatter.yvar = "reimbursement";
		ac.logUserActivity("Change scatterplot Y-axis to Medicare reimbursement", "changeYAxis",  ac.WF_EXAMINE);
                scatter.update();
            });
        d3.select("#scatter-y-mortality")
            .on("click", function () {
                scatter.yvar = "mortality";
		ac.logUserActivity("Change scatterplot Y-axis to mortality rate", "changeYAxis",  ac.WF_EXAMINE);
                scatter.update();
            });
    },
...
$(function () {
    ...
    // ac = draperLog;
    // ac.register("http://localhost:1337", "KitwareHospitalCosts", "0.1")
    ...
    d3.csv("Medicare_Provider_Charge_Inpatient_DRG100_FY2011_filtered.csv", function (error, records) {
		...
		ac.logUserActivity("Change plot type to Scatter Plot", "switchChartType",  ac.WF_EXAMINE);
                d3.select("#home").style("display", "none");
                d3.select("#scatter").style("display", "inline");
            });
            d3.select("#home-link").on("click", function () {
		ac.logUserActivity("Change plot type to Bar Graph Plot", "switchChartType",  ac.WF_EXAMINE);
